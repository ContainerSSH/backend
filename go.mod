module github.com/containerssh/backend

go 1.14

require (
	github.com/containerssh/configuration v0.9.6
	github.com/containerssh/docker v0.9.7
	github.com/containerssh/geoip v0.9.4
	github.com/containerssh/kubernetes v0.9.5
